  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3">
        <div onClick={() => setTab('tokens')} className="bg-white rounded-xl border border-slate-100 p-2 sm:p-3 shadow-sm cursor-pointer hover:border-brand-teal hover:shadow-md transition-all"><p className="text-[8px] sm:text-[9px] font-semibold text-slate-400 uppercase">Tokens</p><p className="text-base sm:text-lg font-black text-slate-800">{stats.tokensTotal}</p></div>
        <div onClick={() => setTab('tokens')} className="bg-white rounded-xl border border-slate-100 p-2 sm:p-3 shadow-sm cursor-pointer hover:border-brand-teal hover:shadow-md transition-all"><p className="text-[8px] sm:text-[9px] font-semibold text-slate-400 uppercase">Ativos</p><p className="text-base sm:text-lg font-black text-emerald-600">{stats.tokensAtivos}</p></div>
        <div onClick={() => setTab('usuarios')} className="bg-white rounded-xl border border-slate-100 p-2 sm:p-3 shadow-sm cursor-pointer hover:border-brand-teal hover:shadow-md transition-all"><p className="text-[8px] sm:text-[9px] font-semibold text-slate-400 uppercase">Usuários</p><p className="text-base sm:text-lg font-black text-blue-600">{stats.usuariosAtivos}</p></div>
        <div onClick={() => setTab('questionarios')} className="bg-white rounded-xl border border-slate-100 p-2 sm:p-3 shadow-sm cursor-pointer hover:border-brand-teal hover:shadow-md transition-all"><p className="text-[8px] sm:text-[9px] font-semibold text-slate-400 uppercase">Questionários</p><p className="text-base sm:text-lg font-black text-violet-600">{stats.questionariosAtivos}</p></div>
        <div onClick={() => setTab('respostas')} className="bg-white rounded-xl border border-slate-100 p-2 sm:p-3 shadow-sm cursor-pointer hover:border-brand-teal hover:shadow-md transition-all"><p className="text-[8px] sm:text-[9px] font-semibold text-slate-400 uppercase">Respostas</p><p className="text-base sm:text-lg font-black text-amber-600">{stats.respostasEnviadas}</p></div>
      </div>
