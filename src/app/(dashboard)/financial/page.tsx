...
const FinancialDashboardCharts = dynamic(
  () => import('@/components/charts/FinancialDashboardCharts').then(m => ({ default: m.FinancialDashboardCharts })),
  {
    loading: () => (
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-pulse">
        <div className="bg-white rounded-2xl border border-slate-100 p-5"><div className="h-[200px] bg-slate-50 rounded-xl" /></div>
        <div className="bg-white rounded-2xl border border-slate-100 p-5"><div className="h-[200px] bg-slate-50 rounded-xl" /></div>
      </div>
    ),
    ssr: false,
  ...
  const renderDashboard = () => (
    <div className="space-y-6">
      ...
      <FinancialDashboardCharts
        monthlyBilling={fin.monthlyBilling}
        totalReceived={fin.totalReceived}
        totalPendingReceivable={fin.totalPendingReceivable}
        totalPaidPayable={fin.totalPaidPayable}
        estimatedTaxes={fin.dre.estimatedTaxes}
        cashFlowProjection={fin.cashFlowProjection}
        revenueByClient={fin.revenueByClient}
        revenueByService={fin.revenueByService}
        upcomingDueDates={fin.upcomingDueDates}
      />
